<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background: #DCACBC; padding: 3rem 0; font-family: Sans-Serif">
    <tr>
    <td width="100%" align="center" style="padding: 0 1rem">
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td width="600" align="center">
            <div style="background: #D8759E; color: rgb(255, 255, 255); width: 100%; max-width: 640px;">
                <header style="background: #E37E9E; padding: 1rem;">
                ...
                <h1 style="font-size: 15px; color: white;">Si quiere cancelar su cita porfavor contactenos al número #####</h1>


                <footer style="text-align: center; font-size: 12px; font-family: Sans-Serif; padding: 1rem; color: #white; background: #E53880;">
